...
import { Activity, RoleTypes, Channels, ChannelAccount, ConversationParameters } from '@microsoft/agents-activity'
...
import { IConnectorClient } from './connectorClient'
 ...
 */
export class MCSConnectorClient implements IConnectorClient {
  ...
  /**
   * Creates a new instance of ConnectorClient.
